...
const CartItem = ({ product }: Props) => {
  ...
  return (
    <div className='grid w-full grid-cols-1 gap-2 px-8 md:grid-cols-4 md:gap-4 md:gap-y-0 xl:grid-cols-4 xl:border-b-2 xl:border-[#EEEEEE] xl:py-4'>
      <div className='flex w-full flex-col items-center md:col-span-4 md:flex-row md:gap-4 xl:col-span-2'>
        <Image
      ...
      <div className='flex w-full justify-center gap-2 md:col-start-3 xl:place-items-center'>
        <Button
          tag='button'
          text='-'
