...
const page = () => {
  return (
    <main className='mb-7 flex flex-col items-center justify-center md:mb-14 xl:mb-28'>
      <Hero title='contact' />
      <div className='mb-3 mt-7 flex w-full flex-col items-center gap-4 md:mb-7 md:mt-14 md:flex-row-reverse md:items-start xl:mb-14 xl:mt-28 xl:px-[15vw]'>
        <ContactForm />
        <ContactInfo
      ...
      <div className='mb-3 mt-7 flex w-[80%] flex-col items-center md:mb-7 md:mt-14 md:w-[95%] md:flex-row md:gap-4 xl:mb-14 xl:mt-28 xl:w-full xl:gap-10 xl:px-[15vw] '>
        <Image
