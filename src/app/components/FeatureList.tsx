        ...
        <div key={feature.title}>
          <div className='flex justify-center gap-4 xl:items-start xl:justify-start'>
            <Image
              ...
              height={0}
            />
            <h3 className='text-lg font-medium uppercase text-primary xl:text-base 2xl:text-lg'>
              {feature.title}
            </h3>
          </div>
          <p className='mt-2 max-w-[25ch] px-2 text-base font-light text-primary xl:ml-8 xl:text-sm 2xl:text-base'>
            {feature.description}
          </p>
        </div>
      ))}
